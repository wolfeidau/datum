        ...
        mapreduce(
            ...
            function (key, value, emit) {
                ...
                bc1min.calculate(obj.date, function (err, data) {
                    emit([obj.metric + data.intervalStartDate, '1min'], '' + obj.value);
                });
                bc5min.calculate(obj.date, function (err, data) {
                    emit([obj.metric , data.intervalStartDate, '5min'], '' + obj.value);
                });
                bc1hr.calculate(obj.date, function (err, data) {
                    emit([obj.metric , data.intervalStartDate, '1hr'], '' + obj.value);
                });
            },
            function (acc, value) {
